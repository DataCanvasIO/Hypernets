    ...
    def test_enas_op(self):
        def get_space():
            ...
            with space.as_default():
                ...
                in1 = Input(shape=(28, 28, 1,))
                in2 = Input(shape=(28, 28, 1,))
                conv_op('normal', 0, 0, 'L', [in1, in2], filters)
                space.set_inputs([in1, in2])
                return space
        ...
        ids = []
        space.traverse(get_id)
        assert ids == ['Module_Input_1', 'Module_Input_2', 'ID_normal_C0_N0_L_sepconv5x5_relu_0_',
        ...
        ids = []
        space.traverse(get_id)
        assert ids == ['Module_Input_1', 'Module_Input_2', 'ID_normal_C0_N0_L_sepconv3x3_relu_0_',
        ...
        ids = []
        space.traverse(get_id)
        assert ids == ['Module_Input_1', 'Module_Input_2', 'ID_normal_C0_N0_L_avgpooling3x3_avgpooling3x3_',
                       'Module_AlignFilters_1']
        ...
        ids = []
        space.traverse(get_id)
        assert ids == ['Module_Input_1', 'Module_Input_2', 'ID_normal_C0_N0_L_maxpooling3x3_', 'Module_AlignFilters_2']
        ...
        ids = []
        space.traverse(get_id)
        assert ids == ['Module_Input_1', 'Module_Input_2', 'ID_normal_C0_N0_L_identity']
