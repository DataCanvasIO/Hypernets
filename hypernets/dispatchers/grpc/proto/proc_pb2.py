...
# source: hypernets/dispatchers/grpc/proto/proc.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='hypernets/dispatchers/grpc/proto/proc.proto',
...
_DATACHUNK_DATAKIND = _descriptor.EnumDescriptor(
  name='DataKind',
  full_name='hypernets.dispatchers.proto.DataChunk.DataKind',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
...
_PROCESSREQUEST = _descriptor.Descriptor(
  name='ProcessRequest',
  full_name='hypernets.dispatchers.proto.ProcessRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='program', full_name='hypernets.dispatchers.proto.ProcessRequest.program', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='args', full_name='hypernets.dispatchers.proto.ProcessRequest.args', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='cwd', full_name='hypernets.dispatchers.proto.ProcessRequest.cwd', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='buffer_size', full_name='hypernets.dispatchers.proto.ProcessRequest.buffer_size', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='encoding', full_name='hypernets.dispatchers.proto.ProcessRequest.encoding', index=4,
...
_DATACHUNK = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='kind', full_name='hypernets.dispatchers.proto.DataChunk.kind', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='data', full_name='hypernets.dispatchers.proto.DataChunk.data', index=1,
...
DataChunk = _reflection.GeneratedProtocolMessageType('DataChunk', (_message.Message,), {
  ...
  '__module__' : 'hypernets.dispatchers.grpc.proto.proc_pb2'
  # @@protoc_insertion_point(class_scope:hypernets.dispatchers.proto.DataChunk)
  })
...
_PROCESSBROKER = _descriptor.ServiceDescriptor(
  name='ProcessBroker',
  full_name='hypernets.dispatchers.proto.ProcessBroker',
  file=DESCRIPTOR,
  index=0,
  serialized_options=None,
  create_key=_descriptor._internal_create_key,
  ...
  _descriptor.MethodDescriptor(
    name='run',
    full_name='hypernets.dispatchers.proto.ProcessBroker.run',
    index=0,
